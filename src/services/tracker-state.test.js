...
describe("TrackerState", () => {
  ...
  describe("getEntranceForExit", () => {
    ...
    test("returns the value of the entrance", () => {
      const entranceValue = state.getEntranceForExit(
  ...
  describe("setEntranceForExit", () => {
    ...
    test("returns a new state with the entrance value modified", () => {
      const newState = state.setEntranceForExit(
        "Needle Rock Isle Secret Cave",
        "Forbidden Woods"
      );

      expect(newState.entrances["Needle Rock Isle Secret Cave"]).toEqual(
        "Forbidden Woods"
      );
    });
  ...
  describe("isLocationChecked", () => {
    ...
    test("returns whether the location is checked", () => {
      const isLocationChecked = state.isLocationChecked(
        "Dragon Roost Cavern",
        "Bird's Nest"
      );
  ...
  describe("toggleLocationChecked", () => {
    ...
    describe("when the location is already checked", () => {
      ...
      test("returns a new state with the location not checked", () => {
        const newState = state.toggleLocationChecked(
          "Dragon Roost Cavern",
          "Bird's Nest"
        );

        const newIsLocationChecked = _.get(newState.locationsChecked, [
          "Dragon Roost Cavern",
          "Bird's Nest",
        ]);
