...
describe("BooleanExpression", () => {
  ...
  describe("_isEqualTo", () => {
    ...
    beforeEach(() => {
      ...
      mockAreItemsEqual = ({ item, otherItem }) =>
        _.trim(item) === _.trim(otherItem);
    });
  ...
  describe("reduce", () => {
    ...
    test("correctly reduces an expression", () => {
      const reducedExpression = expression.reduce({
        andInitialValue: "[AND]",
        andReducer: ({ accumulator, item, isReduced, index, collection }) => {
        ...
        orInitialValue: "[OR]",
        orReducer: ({ accumulator, item, isReduced, index, collection }) => {
          const itemString = isReduced ? `(${item})` : item;
          if (index === 0) {
            return `${accumulator} ${itemString}`;
          }
      ...
      expect(reducedExpression).toEqual(
        "[OR] Apple |2| ([AND] Banana &3& ([OR] Coconut |2| Egg) &3& Durian)"
      );
    });
  });
  ...
  describe("simplify", () => {
    ...
    testSimplify("test 9", {
      initial: BooleanExpression.or(BooleanExpression.and("Apple")),
      expected: BooleanExpression.and("Apple"),
    });

    testSimplify("test 10", {
      initial: BooleanExpression.and(
        BooleanExpression.or(BooleanExpression.and("Apple"))
      ),
      expected: BooleanExpression.and("Apple"),
    });

    testSimplify("test 11", {
      initial: BooleanExpression.and(BooleanExpression.or("Apple", "Banana")),
      expected: BooleanExpression.or("Apple", "Banana"),
    });
    ...
    testSimplify("test 14", {
      initial: BooleanExpression.or(
        "Apple",
        BooleanExpression.and(),
        BooleanExpression.or(BooleanExpression.and())
      ),
      expected: BooleanExpression.and("Apple"),
    });
    ...
    testSimplify("test 15", {
      ...
      expected: BooleanExpression.and(
        BooleanExpression.or("Apple", "Banana", "Coconut", "Durian"),
        "Egg"
      ),
    });

    testSimplify("test 16", {
      initial: BooleanExpression.and("Apple", "Banana", "Banana"),
      expected: BooleanExpression.and("Apple", "Banana"),
    });

    testSimplify("test 17", {
      initial: BooleanExpression.or(
        BooleanExpression.and("Apple", "Apple", "Banana"),
        BooleanExpression.and("Durian", "Durian")
      ),
    ...
    testSimplify("test 18", {
      initial: BooleanExpression.or("5x Apple", "6x Apple"),
      expected: BooleanExpression.and("5x Apple"),
    });

    testSimplify("test 19", {
      initial: BooleanExpression.and("5x Apple", "6x Apple"),
      expected: BooleanExpression.and("6x Apple"),
    });

    testSimplify("test 20", {
      initial: BooleanExpression.or("5x Apple", "6x Apple", "Never"),
      expected: BooleanExpression.and("5x Apple"),
    });

    testSimplify("test 21", {
      initial: BooleanExpression.or("5x Apple", "6x Apple", "Always"),
      expected: BooleanExpression.and("Always"),
    });

    testSimplify("test 22", {
      initial: BooleanExpression.and("5x Apple", "6x Apple", "Never"),
      expected: BooleanExpression.and("Never"),
    });

    testSimplify("test 23", {
      initial: BooleanExpression.and("5x Apple", "6x Apple", "Always"),
      expected: BooleanExpression.and("6x Apple"),
    });
    ...
    testSimplify("test 41", {
      initial: BooleanExpression.and(
        "Apple",
        "Banana",
        BooleanExpression.or("Apple", BooleanExpression.and("Apple", "Banana"))
      ),
      expected: BooleanExpression.and("Apple", "Banana"),
    });
    ...
    testSimplify("test 42", {
      initial: BooleanExpression.or(
        "Apple",
        "Banana",
        BooleanExpression.and("Apple", BooleanExpression.or("Apple", "Banana"))
      ),
      expected: BooleanExpression.or("Apple", "Banana"),
    });
    ...
    testSimplify("test 49", {
      initial: BooleanExpression.and(
        ...
        BooleanExpression.or(
          BooleanExpression.and(
            "Apple",
            BooleanExpression.or(BooleanExpression.and("Durian"), "Always")
          ),
          "Banana"
        )
      ),
    ...
    testSimplify("test 50", {
      initial: BooleanExpression.or(
        ...
        BooleanExpression.and(
          BooleanExpression.or(
            "Apple",
            BooleanExpression.and(BooleanExpression.or("Durian"), "Never")
          ),
          "Banana"
        )
      ),
    ...
    testSimplify("test 59", {
      initial: BooleanExpression.and(
        ...
        BooleanExpression.or("Apple", "Banana", "Coconut", "Durian", "Eclair")
      ),
      expected: BooleanExpression.or(
        "Apple",
        "Banana",
    ...
    testSimplify("test 60", {
      initial: BooleanExpression.or(
        ...
        BooleanExpression.and("Apple", "Banana", "Coconut", "Durian", "Eclair")
      ),
      expected: BooleanExpression.and(
        "Apple",
        "Banana",
    ...
    testSimplify("test 63", {
      initial: BooleanExpression.and(
        "Apple",
        BooleanExpression.or("Never", "2x Banana", "Coconut", "Durian"),
        BooleanExpression.or("Never", "3x Banana", "Durian"),
        BooleanExpression.or("Never", "Durian", "3x Banana")
      ),
      expected: BooleanExpression.and(
        "Apple",
        BooleanExpression.or("3x Banana", "Durian")
      ),
    });
  });
});
