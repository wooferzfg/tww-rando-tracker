  ...
  describe('simplify', () => {
    ...
    testSimplify('test 64', {
      initial: BooleanExpression.and(
        BooleanExpression.or(
          '2x Apple',
          'Banana',
          BooleanExpression.and('Coconut', '2x Durian'),
        ),
        BooleanExpression.or(
          '3x Apple',
          BooleanExpression.and('Coconut', '3x Durian'),
        ),
      ),
      expected: BooleanExpression.or(
        '3x Apple',
    ...
    testSimplify('test 65', {
      initial: BooleanExpression.or(
        BooleanExpression.and(
          '3x Apple',
          'Banana',
          BooleanExpression.or('Coconut', '3x Durian'),
        ),
        BooleanExpression.and(
          '2x Apple',
          BooleanExpression.or('Coconut', '2x Durian'),
        ),
      ),
      expected: BooleanExpression.and(
        '2x Apple',
    ...
    testSimplify('test 66', {
      initial: BooleanExpression.and(
        ...
        BooleanExpression.or(
          BooleanExpression.and('3x Apple', 'Eclair'),
          BooleanExpression.and('Coconut', '3x Durian'),
        ),
      ),
      expected: BooleanExpression.or(
    ...
    testSimplify('test 67', {
      initial: BooleanExpression.or(
        ...
        BooleanExpression.and(
          BooleanExpression.or('2x Apple', 'Eclair'),
          BooleanExpression.or('Coconut', '2x Durian'),
        ),
      ),
      expected: BooleanExpression.and(
