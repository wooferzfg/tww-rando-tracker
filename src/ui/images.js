...
export default class Images {
  ...
  static async _resolveImports(imageImports, keys = []) {
    await Promise.all(
      _.map(imageImports, (importValue, importKey) =>
        this._resolveImportValue(importValue, keys, importKey)
      )
    );
  }
  ...
  static get _IMAGE_IMPORTS() {
    return {
      ...
      DUNGEON_CHART_BACKGROUNDS: {
        [LogicHelper.DUNGEONS.DRAGON_ROOST_CAVERN]: import(
          "../images/dungeon_mapfull0.png"
        ),
        [LogicHelper.DUNGEONS.FORBIDDEN_WOODS]: import(
          "../images/dungeon_mapfull1.png"
        ),
        [LogicHelper.DUNGEONS.TOWER_OF_THE_GODS]: import(
          "../images/dungeon_mapfull2.png"
        ),
        [LogicHelper.DUNGEONS.FORSAKEN_FORTRESS]: import(
          "../images/dungeon_mapfull3.png"
        ),
        [LogicHelper.DUNGEONS.EARTH_TEMPLE]: import(
          "../images/dungeon_mapfull4.png"
        ),
        [LogicHelper.DUNGEONS.WIND_TEMPLE]: import(
          "../images/dungeon_mapfull5.png"
        ),
        [LogicHelper.DUNGEONS.GANONS_TOWER]: import(
          "../images/dungeon_mapfull6.png"
        ),
      },
      DUNGEON_ENTRANCE: {
      ...
      ISLAND_CHART_BACKGROUNDS: {
        [LogicHelper.ISLANDS.FORSAKEN_FORTRESS]: import(
          "../images/mapfull0.png"
        ),
        [LogicHelper.ISLANDS.STAR_ISLAND]: import("../images/mapfull1.png"),
        [LogicHelper.ISLANDS.NORTHERN_FAIRY_ISLAND]: import(
          "../images/mapfull2.png"
        ),
        [LogicHelper.ISLANDS.GALE_ISLE]: import("../images/mapfull3.png"),
        [LogicHelper.ISLANDS.CRESCENT_MOON_ISLAND]: import(
          "../images/mapfull4.png"
        ),
        [LogicHelper.ISLANDS.SEVEN_STAR_ISLES]: import(
          "../images/mapfull5.png"
        ),
        ...
        [LogicHelper.ISLANDS.MOTHER_AND_CHILD_ISLES]: import(
          "../images/mapfull8.png"
        ),
        [LogicHelper.ISLANDS.SPECTACLE_ISLAND]: import(
          "../images/mapfull9.png"
        ),
        [LogicHelper.ISLANDS.WINDFALL_ISLAND]: import(
          "../images/mapfull10.png"
        ),
        [LogicHelper.ISLANDS.PAWPRINT_ISLE]: import("../images/mapfull11.png"),
        [LogicHelper.ISLANDS.DRAGON_ROOST_ISLAND]: import(
          "../images/mapfull12.png"
        ),
        [LogicHelper.ISLANDS.FLIGHT_CONTROL_PLATFORM]: import(
          "../images/mapfull13.png"
        ),
        [LogicHelper.ISLANDS.WESTERN_FAIRY_ISLAND]: import(
          "../images/mapfull14.png"
        ),
        [LogicHelper.ISLANDS.ROCK_SPIRE_ISLE]: import(
          "../images/mapfull15.png"
        ),
        [LogicHelper.ISLANDS.TINGLE_ISLAND]: import("../images/mapfull16.png"),
        [LogicHelper.ISLANDS.NORTHERN_TRIANGLE_ISLAND]: import(
          "../images/mapfull17.png"
        ),
        [LogicHelper.ISLANDS.EASTERN_FAIRY_ISLAND]: import(
          "../images/mapfull18.png"
        ),
        [LogicHelper.ISLANDS.FIRE_MOUNTAIN]: import("../images/mapfull19.png"),
        [LogicHelper.ISLANDS.STAR_BELT_ARCHIPELAGO]: import(
          "../images/mapfull20.png"
        ),
        ...
        [LogicHelper.ISLANDS.TOWER_OF_THE_GODS]: import(
          "../images/mapfull25.png"
        ),
        [LogicHelper.ISLANDS.EASTERN_TRIANGLE_ISLAND]: import(
          "../images/mapfull26.png"
        ),
        [LogicHelper.ISLANDS.THORNED_FAIRY_ISLAND]: import(
          "../images/mapfull27.png"
        ),
        [LogicHelper.ISLANDS.NEEDLE_ROCK_ISLE]: import(
          "../images/mapfull28.png"
        ),
        [LogicHelper.ISLANDS.ISLET_OF_STEEL]: import("../images/mapfull29.png"),
        [LogicHelper.ISLANDS.STONE_WATCHER_ISLAND]: import(
          "../images/mapfull30.png"
        ),
        [LogicHelper.ISLANDS.SOUTHERN_TRIANGLE_ISLAND]: import(
          "../images/mapfull31.png"
        ),
        [LogicHelper.ISLANDS.PRIVATE_OASIS]: import("../images/mapfull32.png"),
        [LogicHelper.ISLANDS.BOMB_ISLAND]: import("../images/mapfull33.png"),
        [LogicHelper.ISLANDS.BIRDS_PEAK_ROCK]: import(
          "../images/mapfull34.png"
        ),
        [LogicHelper.ISLANDS.DIAMOND_STEPPE_ISLAND]: import(
          "../images/mapfull35.png"
        ),
        ...
        [LogicHelper.ISLANDS.SOUTHERN_FAIRY_ISLAND]: import(
          "../images/mapfull38.png"
        ),
        ...
        [LogicHelper.ISLANDS.CLIFF_PLATEAU_ISLES]: import(
          "../images/mapfull41.png"
        ),
        [LogicHelper.ISLANDS.HORSESHOE_ISLAND]: import(
          "../images/mapfull42.png"
        ),
        [LogicHelper.ISLANDS.OUTSET_ISLAND]: import("../images/mapfull43.png"),
        [LogicHelper.ISLANDS.HEADSTONE_ISLAND]: import(
          "../images/mapfull44.png"
        ),
        ...
        [LogicHelper.ISLANDS.FIVE_STAR_ISLES]: import(
          "../images/mapfull48.png"
        ),
        [LogicHelper.MISC_LOCATIONS.MAILBOX]: import("../images/mapfull49.png"),
        [LogicHelper.MISC_LOCATIONS.THE_GREAT_SEA]: import(
          "../images/mapfull50.png"
        ),
